        ...
        <div className='flex justify-end'>
          ...
          {isAuthenticated && (
            <Popover
              ...
              renderPopover={
                <div className='relative rounded-sm cursor-pointer items-center py-1 hover:textwhite/70'>
                  <Link
                    to={path.profile}
            ...
            <Popover
              renderPopover={
                <div className='bg-white relative shadow-md rounded-sm border border-gray-200 max-w-[400px] text-sm'>
                  <div className='p-2'>
                    <p className='text-gray-400 capitalize'>Sản phẩm mới thêm</p>
                    <div className='mt-5'>
                      <div className='mt-4 flex'>
                        <div className='flex-shrink-0'>
                          <img
                            src='https://media3.coolmate.me/cdn-cgi/image/quality=80,format=auto/uploads/June2024/ao_xanh.jpg'
                            alt='ao coolmate'
                            className='w-11 h-11 object-cover'
                          />
                        </div>
                        <div className='flex-grow ml-2 overflow-hidden'>
                          <p className='truncate'>Áo Thun Chạy Bộ Graphic Special</p>
                        </div>
